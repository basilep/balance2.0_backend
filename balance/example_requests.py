...
#req = requests.post("https://balance.e-kot.be/balance/box_data", {"temperature":7, "humidity":7})
...
#req = requests.post("https://balance.e-kot.be/balance/balance/2", {"related_beer_id":10, "remaining_beer":180})
